...
app.all('/api/sheets/fetch', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (!url || typeof url !== 'string' || url.includes('1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms')) {
      ...
      } else if (sLower.includes('sub_hse_p') || sLower.includes('sub-hse-p') || sLower === 'sub_hse_p' || tileId === 'sub-hse-p' || tileId.includes('sub-hse-p')) {
      ...
      } else if (sLower.includes('sub_hse_ei') || sLower.includes('sub_hse _e&i') || sLower.includes('sub-hse-ei') || sLower.includes('e&i') || tileId === 'sub-hse-ei' || tileId.includes('sub-hse-ei')) {
      ...
      } else if (sLower.includes('sub_hse_mech') || sLower.includes('sub-hse-mech') || sLower.includes('mech') || tileId === 'sub-hse-mech' || tileId.includes('sub-hse-mech')) {
...
import { STRATEGIC_TILE_REGISTRY, getSheetUrlForTile, getCandidateTabsForTile, parseCsvToStrategicActions } from './api/strategic/_registry.ts';
